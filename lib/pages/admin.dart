...
import 'package:food_delivery_app/pages/reservation.dart';
import 'package:food_delivery_app/widgets/bottom_bar.dart';
import 'package:food_delivery_app/widgets/square_button.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomBar(
        selectedIndex: 3, // Indica que el índice seleccionado es el cuarto (índice 3)
        onTabSelected: (index) {
          switch (index) {
            case 0:
